...
export default function TermsAndConditions() {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <p>Welcome to Feed Farm!</p>

      <p>This site makes use of the following technologies and assets:</p>
      ...
      <p>
        <div>
          ...
          <ul>
            ...
            <li>
              <a href="https://unsplash.com/@tarutoa?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">
                Tarutoa
              </a>{' '}
              on Unsplash
            </li>
      ...
      <p>
        ...
        of Feed Farm's Website, located at feed.farm.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Feed Farm if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing Feed Farm, you agreed to use
        cookies in agreement with the Feed Farm's Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, Feed Farm and/or its licensors own the
        intellectual property rights for all material on Feed Farm. All
        intellectual property rights are reserved. You may access this from Feed
        Farm for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Feed Farm</li>
        <li>Sell, rent or sub-license material from Feed Farm</li>
        <li>Reproduce, duplicate or copy material from Feed Farm</li>
        <li>Redistribute content from Feed Farm</li>
      </ul>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. Feed
        Farm does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Feed Farm,its agents and/or affiliates. Comments reflect the views
        and opinions of the person who post their views and opinions. To the
        extent permitted by applicable laws, Feed Farm shall not be liable for
      ...
      <p>
        Feed Farm reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Feed Farm a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Feed Farm; and (d) the link is
      ...
      <p>
        ...
        e-mail to Feed Farm. Please include your name, your organization name,
      ...
      <p>
        No use of Feed Farm's logo or other artwork will be allowed for linking
