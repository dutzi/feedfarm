...
export default function CookiePolicy() {
  ...
  return (
    <div className={styles.wrapper}>
      <h1>Cookie Policy for Feed Farm</h1>

      <p>
        This is the Cookie Policy for Feed Farm, accessible from{' '}
        <a href="https://feed.farm">https://feed.farm</a> and any other domain
        affiliated with Feed Farm.
      </p>
